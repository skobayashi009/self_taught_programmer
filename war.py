...
class Game:
    def __init__(self):
        name1 = input("Name of the player1: ")
        name2 = input("Name of the player2: ")
        self.deck = Deck()
    ...
    def play_game(self):
        ...
        print("Let's start a war game!")
        while len(cards) >= 2:
            m = "Press q to exit and others to play:"
            response = input(m)
            if response == "q":
                break
        ...
        print("The game is over, and {} wins.".format(win))
